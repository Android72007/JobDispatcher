...
public class ReminderUtilities {
    ...
    private static final String JOB_TAG = "hydreation_job";
    private static boolean isJobInitiliazed ;
    ...
    synchronized public static void scheduleChargingReminder(Context context){
        ...
        Job constraintnewjob = dispatcher.newJobBuilder()
                ...
                .build();
        dispatcher.schedule(constraintnewjob);
        isJobInitiliazed = true;
    }
